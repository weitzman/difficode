...
[1\. Personal Data that we collect and how we use and share it](https://stripe.com/privacy#1-personal-data-we-collect-and-how-we-use-and-share-it)

[2\. More ways we collect, use and share Personal Data](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data)

[3\. Legal bases for processing data](https://stripe.com/privacy#3-legal-bases-for-processing-personal-data)

[4\. Your rights and choices](https://stripe.com/privacy#4-your-rights-and-choices)

[5\. Security and retention](https://stripe.com/privacy#5-security-and-retention)

[6\. International data transfers](https://stripe.com/privacy#6-international-data-transfers)

[7\. Updates and notifications](https://stripe.com/privacy#7-updates-and-notifications)

[8\. Jurisdiction-specific provisions](https://stripe.com/privacy#8-jurisdiction-specific-provisions)

[9\. Contact us](https://stripe.com/privacy#9-contact-us)

[10\. US Consumer Privacy Notice](https://stripe.com/privacy#10-us-consumer-privacy-notice)
...
**More**. For further information about ways we may use and share End Users' Personal Data, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
**More**. For further information about other types of Personal Data that we may collect about End Customers, including about your online activity, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
During payment transactions, your Personal Data is shared with various entities in connection with your transaction. As a service provider or data processor, we share Personal Data to enable transactions as directed by Business Users. For instance, when you choose a payment method for your transaction, we may share your Transaction Data with your bank or other payment method provider, including as necessary to authenticate you, [Learn More](https://stripe.com/legal/privacy-center#:~:text=How%20does%20Stripe%20use%20and%20share%20data%20to%20authenticate%20my%20transactions%3F), process your transaction, prevent fraud, and handle disputes. The Business User you choose to do business with also receives Transaction Data and might share the data with others. Please review your merchant’s, bank’s, and payment method provider’s privacy policies for more information about how they use and share your Personal Data.
...
**More**. For further information about additional ways by which we may use and share End Customers' Personal Data, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
**More**. For further information about other types of Personal Data that we may collect about Representatives, including your online activity, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
**More**. For further information about additional ways by which we may use and share Representatives’ Personal Data, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
**More**. Further details about other types of Personal Data that we may collect from Visitors, including your online activity, can be found in the [*More ways we collect, use, and share Personal Data*](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
**More**. For more information about additional ways we may use and share Visitors’ Personal Data, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
For purposes of the General Data Protection Regulation (GDPR) and other applicable data protection laws, we rely on a number of legal bases to process your Personal Data. [Learn More](https://stripe.com/legal/privacy-center#stripe-legal-bases-tables). For some jurisdictions, there may be additional legal bases, which are outlined in the [Jurisdiction-Specific Provisions](https://stripe.com/privacy#8-jurisdiction-specific-provisions) section below.
...
*   Determination of eligibility for and offering new Stripe Services ([Learn More](https://stripe.com/legal/privacy-center#stripe-capital-direct-and-capital-for-platforms));
...
*   The right to request access to the Personal Data Stripe processes about you ([Learn More](https://stripe.com/legal/privacy-center#how-do-i-access-my-data));
...
Stripe, LLC complies with the EU-U.S. Data Privacy Framework (“EU-U.S. DPF”), the UK Extension to the EU-U.S. DPF, and the Swiss-U.S. Data Privacy Framework as set forth by the U.S. Department of Commerce and as applicable. [Learn More](https://stripe.com/en-ie/legal/data-privacy-framework).
...
*   **United States**. If you are a consumer located in the United States (“US”), we process your personal information in accordance with US federal and state privacy laws. For additional  details, please review the information below and see our additional U.S. Privacy Disclosures [here](https://stripe.com/legal/privacy-center#categories-of-personal-information-collected-and-disclosed-under-the-ccpa:~:text=period%20of%20time.-,U.S.%20Privacy%20Disclosures,-Categories%20of%20Personal). Stripe uses cookies, including advertising cookies, as described in our [Cookie Policy](https://stripe.com/legal/cookies-policy).
    ...
    *   **Global Privacy Control signals**. Stripe honors the Global Privacy Control (GPC) opt-out preference signals. [Learn More](https://stripe.com/legal/privacy-center#contact-us).

## 9\. Contact us

If you have any questions or complaints about this Policy, please [contact us](https://stripe.com/legal/privacy-center#contact-us). If you are an End Customer (i.e., an individual doing business or transacting with a Business User), please refer to the privacy policy or notice of the Business User for information regarding the Business User’s privacy practices, choices and controls, or contact the Business User directly.
...
Stripe, LLC, Stripe Payments Company, and their affiliates that provide consumers services in the U.S.
...
For additional information about our privacy practices, please visit the [Stripe Privacy Center](https://stripe.com/privacy-center/legal).