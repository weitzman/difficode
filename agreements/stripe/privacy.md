...
**More**. For further information about additional ways in which we may use and share End Customers' Personal Data, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
For our everyday business purposes – such as to process your transactions, detect fraud and prevent loss for you, us, as well as our Business Users and Financial Partners, maintain your account(s), respond to court orders and legal investigations, or report to credit bureaus
...
Stripe, Stripe Payments Company, and their affiliates that provide consumers services in the U.S.
