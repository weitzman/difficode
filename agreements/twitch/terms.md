...
The Terms of Service apply whether you are a user that registers an account with the Twitch Services or an unregistered user. You agree that by clicking “Sign Up” or otherwise registering, downloading, accessing, or using the Twitch Services, you are entering into a legally binding agreement between you and Twitch regarding your use of the Twitch Services and any activity that occurs under your account. You acknowledge that you have read, understood, and agree to be bound by these Terms of Service. If you do not agree to these Terms of Service, do not access or otherwise use any of the Twitch Services.
...
You are responsible for providing accurate information about yourself and for keeping your Twitch account secure.

If you allow others to use your account or allow other Twitch accounts or third parties to take actions on your behalf, you are responsible for the actions they take on Twitch under your account.

If your account takes any action on behalf of another account, you are promising that you are allowed to take that action.
...
You are solely responsible for maintaining the confidentiality of your account, your password and for restricting access to the device(s) on which you use your account. If you permit others to use your account credentials, you agree to these Terms of Service on behalf of all other persons who use the Twitch Services under your account or password, and you are responsible for all activities that occur under your account or password.
...
Twitch may provide functionality allowing you to authorize other Twitch accounts to access, use, post, or manage data, content, offers, or other features on the Twitch Services on your behalf (“Authorized Users”), or third party tools to do the same. When you designate another user as an Authorized User or enable a third-party tool to perform the activities of an Authorized User, you represent and warrant that: (i) you are solely responsible for all of their activities occurring under your account, (ii) the Authorized User’s activities comply with these Terms of Service and the Guidelines, and (iii) Twitch does not and will not have liability for the Authorized User’s acts or omissions. When you act as an Authorized User for another Twitch user’s account, you represent and warrant that: (i) you have the valid right and authority to access or act under that user’s account, including (as applicable) the right and authority to accept agreements on behalf of that user, and (ii) if your authorization from that user expires or is revoked, you will immediately stop accessing or acting under that user’s account.
...
We refer to everything you create on Twitch or provide to us as “User Content”. This includes content created by your authorized users, third-party tools you use, and Twitch’s automated tools you use.

Twitch allows you to distribute streaming live and pre-recorded audio-visual works; to use services, such as chat, bulletin boards, forum postings, wiki contributions, and voice interactive services; and to participate in other activities in which you may create, post, transmit, perform, or store content, messages, text, sound, images, applications, code, or other data or materials on the Twitch Services (“User Content”). By live streaming or otherwise making User Content available on Twitch, you are directing Twitch to also cache and/or store your User Content and every individual piece of it (such as each video clip, audio segment, image, or text). You are also directing Twitch to use any automated tools enabled on your account to generate and store additional content for you, which is also your User Content. Similarly, if you choose to enable Authorized Users or third-party applications to perform any activities under your account, you are directing them to create content for you and it is also your User Content.
...
You agree not to solicit the use of or use any Twitch monetization tool (e.g., Bits or subscriptions) for the purpose of making or delivering a contribution to a candidate, candidate’s committee, political action committee, ballot committee, or any other campaign committee, or otherwise for the purpose of influencing any election. Politicians, candidates for political office, campaign committees, political action committees, political party committees, and government entities are not eligible to use any Twitch monetization tool on their channels.
...
Twitch has the right to end or suspend your ability to use the Twitch Services, including your access to any purchased products or services.
...
Most disputes can be resolved informally, so you agree to contact us before initiating a lawsuit related to these Terms of Service or your use of the Twitch Services. Submit your informal dispute resolution notice to our registered agent, Corporation Service Company (“CSC”), using the instructions provided on our [Service of Process](https://legal.twitch.com/legal/service-of-process) page. Include the information necessary for Twitch to investigate and respond, including your name, your Twitch username (if you have a registered Twitch account), a description of the dispute and alleged harm, your contact email address, and the name and contact information for your attorney, if you are represented by one (“Notice of Dispute”).

After you send us the required Notice of Dispute, you and Twitch will have 60 days from Twitch’s receipt to engage in informal discussions to attempt to resolve the dispute amicably. To the extent permitted by applicable law, you must engage in this informal resolution process before starting any formal dispute process. Any applicable statutes of limitations will be tolled for the 60-day period following Twitch’s receipt of your Notice of Dispute, to allow the parties to attempt informal resolution.
