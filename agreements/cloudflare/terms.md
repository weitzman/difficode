...
*Welcome to Cloudflare! As used in these Terms of Use, "Cloudflare", "us" or "we" refers to Cloudflare, Inc. and its affiliates.*
...
THESE TERMS DO NOT APPLY TO YOUR ACCESS AND USE OF THE CLOUDFLARE PRODUCTS AND SERVICES THAT ARE PROVIDED UNDER THE [SELF-SERVE SUBSCRIPTION AGREEMENT](/terms/), THE [ENTERPRISE SUBSCRIPTION AGREEMENT](/enterpriseterms/), OR OTHER WRITTEN AGREEMENT SIGNED BETWEEN YOU AND CLOUDFLARE (IF APPLICABLE).
...
[Self-Serve Subscription Agreement](/terms/)
...
[Trust & Safety](/trust-hub/abuse-approach/)
