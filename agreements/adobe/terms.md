...
[Watch the video](https://video.tv.adobe.com/v/3429998?end=nothing&learn=on)
...
1.  [Your Agreement with Adobe](/legal/terms.html#your-agreement-with-adobe)
2.  [Privacy](/legal/terms.html#privacy)
3.  [Use of Services and Software](/legal/terms.html#use-of-services-and-software)
4.  [Your Content](/legal/terms.html#your-content)
5.  [Your Account](/legal/terms.html#your-account)
6.  [User Conduct](/legal/terms.html#user-conduct)
7.  [Fees and Payment](/legal/terms.html#fees-and-payment)
8.  [Your Warranty and Indemnification Obligations](/legal/terms.html#your-warranty-and-indemnification-obligations)
9.  [DISCLAIMERS OF WARRANTIES](/legal/terms.html#disclaimers-of-warranties)
10.  [LIMITATION OF LIABILITY](/legal/terms.html#limitation-of-liability)
11.  [Termination](/legal/terms.html#termination)
12.  [Trade Sanctions and Export Control Compliance](/legal/terms.html#trade-sanctions-and-export-control-compliance)
13.  [Australian Consumer Law](/legal/terms.html#australian-consumer-law)
14.  [Dispute Resolution, Class Action Waiver, Arbitration Agreement](/legal/terms.html#dispute-resolution-class-action-waiver-arbitration-agreement)
15.  [Audit Rights](/legal/terms.html#audit-rights)
16.  [Updates to Services and Software and Availability](/legal/terms.html#updates-to-services-and-software-and-availability)
17.  [No Modifications, Reverse Engineering, Artificial Intelligence/Machine Learning (AI/ML)](/legal/terms.html#no-modifications-reverse-engineering-artificial-intelligencemachine-learning-aiml)
18.  [Miscellaneous](/legal/terms.html#miscellaneous)
19.  [DMCA](/legal/terms.html#dmca)

These General Terms of Use (“**General Terms**”), along with any applicable Product Specific Terms (see section 1.2 (Product Specific Terms) below) (collectively, the “**Terms**”) govern your use of and access to our websites, web-based applications and products, customer support, discussion forums or other interactive areas or services, and services such as Creative Cloud (collectively, the “**Services**”) and your installation and use of any software that we include as part of the Services, including, without limitation, mobile and desktop applications, Sample Files and Content Files (defined below), scripts, instruction sets, and related documentation (collectively, the “**Software**”). If you have agreed to the Subscription and Cancellation Terms ([https://www.adobe.com/legal/subscription-terms.html](/legal/subscription-terms.html)), then such terms are also considered part of the Terms. If you are using and accessing the Services and Software through Adobe’s Value Incentive Plan (“VIP”) program, then the Subscription and Cancellation Terms do not apply to you, but the remainder of the Terms will govern your use of and access to the Services and Software. If you have entered into another agreement with us concerning specific Services and Software, then the terms of that agreement control where it conflicts with the Terms.
...
([http://www.adobe.com/go/primary-secondary-terms](/go/primary-secondary-terms).)
...
*   [Adobe Acrobat Services (DC APIs)](/go/acrobatservicesterms)
*   [Adobe Acrobat Sign](/go/adobesignterms)
*   [Adobe ColdFusion](/go/adobe-coldfusion-terms)
*   [Adobe Collaboration Space](/go/collaborationspace-terms)
*   [Adobe Developer](/go/developer-terms)
*   [Adobe Express](/go/creativecloudexpressterms)
*   [Adobe Fonts](/go/adobe-fonts-terms)
*   [Adobe Generative AI](/go/adobe-gen-ai-addl-terms)
*   [Adobe Spark](/go/spark-terms)
*   [Adobe Stock](/go/stockterms)
*   [Adobe Stock Contributor](/go/contributorterms)
*   [Adobe Substance 3D Assets](/go/substance3dassets)
*   [Adobe Substance 3D Community Assets](/go/substance3dcommunityassets)
*   [Behance](/go/BehanceTOU)
*   [Business Customers](/go/business_terms)
*   [Demo Assets](/go/demoassets)
*   [Document Cloud](/go/documentcloudterms)
*   [Frame.io](/go/frameio-terms)
*   [Fuse](/go/fuseterms)
*   [InDesign Server](/go/indesign-server-terms)
*   [K-12 and Higher Education](/go/primary-secondary-terms)
*   [Lightroom](/go/lightroom_terms)
*   [Medium](/go/medium-terms)
*   [Photoshop Express](/go/photoshop_express_terms)
*   [Project Aqua](/go/project-aqua-terms)
*   [Software](/go/softwareterms)
...
For information about how we collect, use, share, or otherwise process information about you and your use of our Services and Software, please see our Privacy Policy ([http://www.adobe.com/go/privacy)](/go/privacy). You have the option to manage information preferences here: [https://www.adobe.com/privacy/opt-out.html](/privacy/opt-out.html).
...
**(D) Content Analytics with Cloud Content.** Subject to your opt-out rights, we may perform Content Analytics (see section 4.3(B)) with Cloud Content to help us understand how our users are using our Services and Software to allow us to improve your Services and Software experience, provide recommendations to you, and customize your experience. Learn more about your right to opt out of us performing Content Analytics using your Content ([adobe.com/go/contentanalysisfaq)](/go/contentanalysisfaq) and usage data ([adobe.com/go/usagedatafaq)](/go/usagedatafaq). Insights from Content Analytics may be used to inform our marketing to you, subject to your opt-out and consent rights regarding our marketing.
...
4.  when you opt in to a prerelease, beta, or product improvement program (like the Adobe Photoshop Improvement Program). [Learn more](https://helpx.adobe.com/manage-account/using/machine-learning-faq.html)
...
(B)  **Education Version.**  If we designate the Services and Software to be for use by educational users (“**Educational Version**”), then you may use the Educational Version only if you meet the eligibility requirements stated at [https://www.adobe.com/go/primary-secondary-institution-eligibility-guidelines](/go/primary-secondary-institution-eligibility-guidelines). You may install and use the Educational Version only in the country where you are qualified as an educational user. If you reside in the EEA, then the word “country” in the prior sentence means the EEA.
...
If we remove your Content for violating the Terms, we will inform you of our decision via the email address you provided to us. If you believe that your Content was removed in error, you may submit an appeal by following the process outlined in our communication to you or at our [Transparency Center](/trust/transparency.html).
...
If you believe your Adobe Account has been deactivated in error, you may submit an appeal by following the process outlined when you attempt to log into your account or at our [Transparency Center](/go/transparencycenter). If you have any related questions, please contact [Adobe Customer Care](/go/csupport_subscripterms).
...
Adobe Customer Care is available to address most concerns that you may have regarding Adobe’s Services and Software. Contact Adobe Customer Care here: [https://www.adobe.com/go/csupport\_subscripterms](/go/csupport_subscripterms).
...
Adobe\_General\_Terms\_of\_Use-en\_US\_20251003
