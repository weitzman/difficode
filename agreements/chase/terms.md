...
Unauthorized entry and use of JPMorgan Chase’s systems includes the use of agents, including AI agents or agentic AI, robots, spiders, scripts, services, software or any manual or automatic device, tool, or process designed to circumvent any restriction, condition, or technological measure that controls access to the JPMorgan Chase’s systems in any way, including overriding any security feature or bypassing or circumventing any access controls or use limits.
...
If you use JPMorgan Chase’s Website or systems to access data related to any account(s) of which you are not the owner or authorized user as reflected in JPMorgan Chase’s systems, you shall indemnify, defend, and hold harmless JPMorgan Chase & Co. and all of its direct and indirect subsidiaries, officers, directors, employees, agents, successors, and assigns from any and all losses, liabilities, damages, and all related costs and expenses, arising from, relating to, or resulting (directly or indirectly) from such access. Further, without limiting JPMorgan Chase’s rights or your obligations under any other provision of these Terms and Conditions, and notwithstanding the same, in the event of any actual or reasonably suspected unauthorized access to the personal information of a customer (including but not limited to customer names, addresses, phone numbers, bank and credit card account numbers, income and credit histories, and social security numbers) under your control or subsequent to and arising from your past exercise of control, direct damages in connection with any such breach will include the cost and expenses of investigation and analysis (including by law firms and forensic firms), correction or restoration of any destroyed, lost or altered data, notification to affected customers, offering and providing of credit monitoring, customers service, or other remediation services, and any related cost. JPMorgan Chase & Co.’s rights to indemnity under this section are in addition to all other rights and remedies available at Law or in equity. Any exercise by JPMorgan Chase & Co. of its rights to indemnification shall be without prejudice to such other rights and remedies. You manifest your assent to this indemnity by accessing account data through JPMorgan Chase’s Website or systems, notwithstanding the terms of any agreement you have with a customer or an account owner stating otherwise. This indemnity includes but is not limited to losses associated with (1) a data breach of your system(s) and (2) a data breach of the system(s) of any person or entity with whom you provided or shared JPMorgan Chase customer account data.

## AI Agent or Agentic AI Notices

For the purposes of JPMorgan Chase ’s Terms of Service, AI Agent or Agentic AI "AI Agent” means any software or service that takes autonomous or semi-autonomous action on behalf of, or at the instruction of, any person or entity. If you use, allow, enable, or cause the deployment of an AI Agent to access, use, or interact with any JPMorgan Chase system, you must ensure that you and the AI Agent adhere to the following conditions:

*   No AI Agent may access, use, or interact with JPMorgan Chase’s systems unless, at all times, it identifies itself as an AI agent and operates in strict accordance with the Terms of Service. In addition, no AI Agent may access, use, or interact with JPMorgan Chase’s systems if we have requested that the AI Agent refrain from accessing, using, or interacting with any JPMorgan Chase’s systems.
*   At our sole discretion, we may limit, prevent, suspend, or terminate, including by technical measures, AI Agent’s access, use, and interactions with JPMorgan Chase’s systems.
*   When accessing, using, or interacting with JPMorgan Chase’s systems, AI Agents must clearly and deterministically label all agentic traffic.
...
When you use, allow, enable, or cause the deployment of an AI Agent, you are responsible for any actions or errors that may result from the Agent’s incorrect interpretation or implementation of your instructions, if it performs unintended actions or exceeds the authority you gave it.
...
The information and materials contained in this Website-and the terms and conditions of the access to and use of such information and materials-are subject to change without notice. Products and services described, as well as associated fees, charges, interest rates, and balance requirements may differ among locations. Not all products and services are offered at all branches, banking centers, online or locations.
...
Si tienes alguna pregunta, por favor llama o [visita una sucursal local de Chase.](/locator)