...
The fees for transactions sent and/or received through Visa+ are described on Venmo’s [Fee page](https://venmo.com/resources/our-fees/). There is no transaction fee for Visa+ transactions sent between PayPal and Venmo. You will receive a receipt for each Visa+ transaction conducted using your Visa+ Payname on Venmo and Visa+ transactions sent or received using your Venmo account will be included on your Venmo account statements.  
