...
*   All requests by governmental entities or parties involved in litigation seeking content data associated with Customers who are under contract with Slack Technologies, LLC, a U.S. company, should be sent to [legalprocess@slack.com](mailto:legalprocess@slack.com).
*   All requests by governmental entities or parties involved in litigation seeking content data associated with Customers who are under contract with Slack Technologies Limited, an Irish Company, should be sent to [intlegalprocess@slack.com](mailto:intlegalprocess@slack.com). These requests will be processed by personnel located in Dublin, Ireland.
